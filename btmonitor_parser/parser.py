...
ELL_HCI_EVENT = 0x84
ELL_HCI_TX_ISO_DATA = 0x05
ELL_HCI_RX_ISO_DATA = 0x85
...
ELL_FLAG_MAP = {
        ...
        BT_MONITOR_ISO_TX_PKT: ELL_HCI_TX_ISO_DATA,
        BT_MONITOR_ISO_RX_PKT: ELL_HCI_RX_ISO_DATA,
        }
...
BTSNOOP_PKT_TYPE = set([2,3,4,5,18,19])
